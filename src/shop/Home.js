                                        ...
                                        <div className="product-image-wrapper">
                                            <div className="single-products" id={1}>
                                                <div className="productinfo text-center">
                                                    <img src="/frontend/images/home/product1.jpg" alt="" className="img_h" />
                                                    <h2 className="price_h">$56</h2>
                                                    <p className="text_h">Easy Polo Black Edition</p>
                                    ...
                                    <div className="col-sm-4">
                                        <div className="product-image-wrapper">
                                            <div className="single-products" id={2}>
                                                <div className="productinfo text-center">
                                                    <img src="/frontend/images/home/product2.jpg" alt="" className="img_h" />
                                                    <h2 className="price_h">$56</h2>
                                                    <p className="text_h">Easy Polo Black Edition</p>
                                                    <a href="#" className="btn btn-default add-to-cart"><i className="fa fa-shopping-cart" />Add to cart</a>
                                                </div>
                                    ...
                                    <div className="col-sm-4">
                                        <div className="product-image-wrapper">
                                            <div className="single-products" id={3}>
                                                <div className="productinfo text-center">
                                                    <img src="/frontend/images/home/product3.jpg" alt="" className="img_h" />
                                                    <h2 className="price_h">$56</h2>
                                                    <p className="text_h">Easy Polo Black Edition</p>
                                                    <a href="#" className="btn btn-default add-to-cart"><i className="fa fa-shopping-cart" />Add to cart</a>
                                                </div>
                                    ...
                                    <div className="col-sm-4">
                                        <div className="product-image-wrapper">
                                            <div className="single-products" id={4}>
                                                <div className="productinfo text-center">
                                                    <img src="/frontend/images/home/product4.jpg" alt="" className="img_h" />
                                                    <h2 className="price_h">$56</h2>
                                                    <p className="text_h">Easy Polo Black Edition</p>
                                                    <a href="#" className="btn btn-default add-to-cart"><i className="fa fa-shopping-cart" />Add to cart</a>
                                                </div>
                                    ...
                                    <div className="col-sm-4">
                                        <div className="product-image-wrapper">
                                            <div className="single-products" id={5}>
                                                <div className="productinfo text-center">
                                                    <img src="/frontend/images/home/product5.jpg" alt="" className="img_h" />
                                                    <h2 className="price_h">$56</h2>
                                                    <p className="text_h">Easy Polo Black Edition</p>
                                                    <a href="#" className="btn btn-default add-to-cart"><i className="fa fa-shopping-cart" />Add to cart</a>
                                                </div>
                                    ...
                                    <div className="col-sm-4">
                                        <div className="product-image-wrapper">
                                            <div className="single-products" id={6}>
                                                <div className="productinfo text-center">
                                                    <img src="/frontend/images/home/product6.jpg" alt="" className="img_h" />
                                                    <h2 className="price_h">$56</h2>
                                                    <p className="text_h">Easy Polo Black Edition</p>
                                                    <a href="#" className="btn btn-default add-to-cart"><i className="fa fa-shopping-cart" />Add to cart</a>
                                                </div>
